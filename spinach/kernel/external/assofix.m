function assofix(action, userExtList, fileStr)

% assofix(action, extList, fileStr)
%
...
%
% EXAMPLES:
% * assofix('deleteadd') - Makes a registry files that deletes all
...
%   was created in.
% * assofix('', {'.m', '.mat', '.fig'}, 'myFile') - Makes a registry file
